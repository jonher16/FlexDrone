    ...
    <>
      ...
      {choice === "Panel" ? (
        <>
          ...
          </div></>) : choice == "Tello" ? (<Tello socket={socket} tellostatus={telloStatus} />) : (<ASDK socket={socket} SOCKET_IP={SOCKET_IP} SOCKET_PORT={SOCKET_PORT} ANDROID_IP={addresses.android}/>)}
